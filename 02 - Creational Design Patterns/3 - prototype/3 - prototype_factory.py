...
class EmployeeFactory:
    office_one_employee = Employee(
        name="", address=Address(street="12 street", city="cairo", country="egpyt")
    )
    office_two_employee = Employee(
        name="", address=Address(street="14 street", city="landon", country="UK")
    )
    custom_address = None
